...
| **SEC-04** Escape dữ liệu người dùng | README SUT | API-01, API-02, API-03 | TC-PRODLIST-028 · TC-PRODUPD-006, 007 · **TC-CART-204/205** · **TC-PRODUPD-201/202** | **BUG-22** (payload `<script>` lưu nguyên trong giỏ) · **BUG-24** (`imageUrl: javascript:` lưu nguyên) — hai case do sinh viên chọn |
