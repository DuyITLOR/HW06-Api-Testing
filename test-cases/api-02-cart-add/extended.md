...
| TC-CART-107 | Schema | **giỏ không được chứa dòng có `quantity ≤ 0`** sau tất cả case trên | `GET /api/cart` | user thường | – | 200 | không dòng nào `quantity ≤ 0` | FR-07 — trạng thái giỏ phải luôn hợp lệ, kể cả sau khi bị gửi input sai | SV | VALID | **FAIL** (1/2 đỏ) |
